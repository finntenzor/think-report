 ...
 * 主要更改：CSS代码压缩
 * datas变量名改为data
 * @source https://github.com/top-think/framework/blob/5.1/tpl/think_exception.tpl
 */
...
<body>
    ...
    <div class="exception-var">
        ...
        <?php foreach ((array) $data as $label => $value) { ?>
        <table>
            <?php if(empty($value)){ ?>
